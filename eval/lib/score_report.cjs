...
const ALIASES = [
  ...
  [/phe|2610602/i, 'phe'], [/a.?level.*limiting|limiting.*excess.?reagent/i, 'alevel'], [/qualitative|limiting/i, 'qual'], [/ice.?cream/i, 'icecream'], [/synth(\d+)/i, m => 'synth' + m[1].padStart(2, '0')],
];
function gtName() {
